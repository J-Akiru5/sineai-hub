...
export default function Create({ auth, categories = [] }) {
    ...
    const [castCrewList, setCastCrewList] = useState([{ name: '', role: '' }]);
        ...
        post(route('projects.store'), {
            onSuccess: () => {
                Swal.fire({
                    ...
                    text: 'Your project has been uploaded successfully.',
                    background: '#1e293b',
                    color: '#fef3c7',
            ...
            onError: () => {
                Swal.fire({
                    icon: 'error',
                    title: 'Upload Failed',
                    text: 'There was an error uploading your project. Please try again.',
                    background: '#1e293b',
                    color: '#fef3c7',
                    confirmButtonColor: '#f59e0b',
                });
    ...
    const languages = ['English', 'Spanish', 'French', 'German', 'Italian', 'Portuguese', 'Russian', 'Japanese', 'Korean', 'Chinese', 'Hindi', 'Arabic', 'Other'];
                                ...
                                <div className="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-2">
                                                <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-amber-500/30 rounded-xl cursor-pointer bg-slate-800/30 hover:bg-slate-800/50 transition">
                                                    {videoPreview ? (
                                                        <video src={videoPreview} className="h-full w-full object-cover rounded-lg" />
                                                    ) : (
                                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                                            ...
                                                            <p className="text-xs text-amber-300/40 mt-1">MP4, WebM, OGG</p>
                                                        </div>
                                                    )}
                                                    <input
                                                        id="video"
                                        ...
                                        {/* Thumbnail Upload */}
                                        <div>
                                            <InputLabel htmlFor="thumbnail" value="Thumbnail (Optional)" className="text-amber-200" />
                                            <div className="mt-2">
                                                <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-amber-500/30 rounded-xl cursor-pointer bg-slate-800/30 hover:bg-slate-800/50 transition">
                                                    {thumbnailPreview ? (
                                                        <img src={thumbnailPreview} alt="Thumbnail" className="h-full w-full object-cover rounded-lg" />
                                                    ) : (
                                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                {data.duration > 0 && (
                                    <div className="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-4">
                                        <div className="flex items-center gap-3 text-amber-300">
                                            ...
                                            <span>Duration: {Math.floor(data.duration / 60)}:{(data.duration % 60).toString().padStart(2, '0')}</span>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
                                    <div className="flex gap-3">
                                        ...
                                        <div className="text-sm text-blue-300/80">
                                            <p>Public projects will be reviewed by our moderation team before appearing in Premiere.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
