                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {items.map((role) => (
                            <tr key={role.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">{role.created_at}</td>
                    ...
                    <div className="w-full max-w-md bg-white rounded shadow p-6">
                        ...
                        <form onSubmit={submitCreate}>
                            ...
                            <div className="flex justify-end gap-2">
                                ...
                                <button type="submit" disabled={submitting} className="px-3 py-1 bg-amber-500 text-white rounded">Create</button>
                            </div>
                        </form>
                    </div>
                </div>
