                            ...
                            <div className="p-6 bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-lg space-y-4">
                                <div>
                                    ...
                                    <div className="mt-3 flex flex-col gap-3">
                                        ...
                                        <Link href={route('studio.editor')} className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-700 text-white rounded-md font-semibold text-center">
